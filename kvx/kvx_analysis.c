...
const char *kvx_reg_profile =
	...
	"=A8	r8\n"
	"=A9	r9\n"
/* FIXME: aliases of three chars are not supported */
#if 0
	"=A10	r10\n"
	"=A11	r11\n"
#endif
...
/* The bundle store several instructions that cannot be disassembled
...
static int kvx_op(RzAnalysis *a, RzAnalysisOp *op, ut64 addr, const ut8 *buf, int len, RzAnalysisOpMask mask) {
...
static char *kvx_get_reg_profile(RzAnalysis *a) {
	return strdup(kvx_reg_profile);
}

RzAnalysisPlugin rz_analysis_plugin_kvx = {
	.name = "kvx",
	...
	.op = kvx_op,
	.get_reg_profile = kvx_get_reg_profile,
};

#ifndef RZ_PLUGIN_INCORE
RZ_API RzLibStruct rizin_plugin = {
	.type = RZ_LIB_TYPE_ANALYSIS,
	.data = &rz_analysis_plugin_kvx,
	.version = RZ_VERSION
};
#endif
